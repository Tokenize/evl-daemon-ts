...
describe("tpi", () => {
  describe("parseCommand", () => {
    test("should return the parsed command", () => {
      const input = "500AB";
      const expected = "500";
  ...
  describe("parseChecksum", () => {
    test("should return the parsed checksum", () => {
      const input = "505AB";
      const expected = "AB";
    ...
    test("should return an empty checksum on invalid input", () => {
      const input = "5A";
      const expected = "";
  ...
  describe("parseData", () => {
    test("should return empty data with invalid input", () => {
      const input = "500AB";
    ...
    test("should set the correct zone for a zone command", () => {
    ...
    test("should set an empty zone for a non-zone command", () => {
    ...
    test("should set the correct partition for a partition command", () => {
      const input = "6507AB";
    ...
    test("should set partition to 0 with non-partition command", () => {
    ...
    test("should set partition and zone for a partition and zone command", () => {
    ...
    test("should set correct value for a non-zone or partition command", () => {
  ...
  describe("parsePartition", () => {
    test("should return the partition with valid input", () => {
      const value = "3889";
      const expected = 3;
    ...
    test("should return 0 with invalid partition number", () => {
      const value = "ZB";
      const expected = 0;
  ...
  describe("parseZone", () => {
    test("should return the zone with valid input", () => {
      const value = "005";
      const expected = "005";
    ...
    test("should return an empty string with empty string as input", () => {
      const value = "";
      const actual = parseZone(value);
      expect(actual).toEqual("");
    });

    test("should return an empty string with an invalid length string", () => {
      const value = "5A";
      const actual = parseZone(value);
      expect(actual).toEqual("");
    });
  ...
  describe("getPayload", () => {
    test("should return a payload from the given input", () => {
  ...
  describe("validate", () => {
    test("should return true with a valid checksum", () => {
      const actual = validate("005user54");

      expect(actual).toBeTruthy();
    });

    test("should return false with an invalid checksum", () => {
      const actual = validate("005userAB");

      expect(actual).toBeFalsy();
    });

    test("should return false with invalid input", () => {
  ...
  describe("calculateChecksum", () => {
    ...
    test("should add a leading zero", () => {
      const value = "5108A";
      const expected = "0F";
    ...
    test("should truncate to 8 bits", () => {
